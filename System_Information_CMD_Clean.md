...
A clean CMD and PowerShell command reference for checking Windows system information, hardware details, network status, installed tools, repair commands, and health diagnostics.

> Note: Some commands require Command Prompt or PowerShell to be opened as Administrator.
...
5. Users, Services, Drivers, and Startup
6. Windows License, Updates, and Security
7. Date, Time, and Environment
8. Export Commands
9. Developer Tool Version Checks
10. Detailed WMIC System Commands
11. Health, Repair, and Diagnostic Commands
...
## Users, Services, Drivers, and Startup
...
## Windows License, Updates, and Security
...
Shows enabled network adapters with speed and MAC address.
...
## Health, Repair, and Diagnostic Commands
